    ...
    <div class="col-md-5">
        <div class="glass-card p-4 p-md-5">
            <div class="text-center mb-5">
                ...
                <p class="text-slate-400">Sign in to manage your premium QR codes</p>
            </div>
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('password.request') }}" class="small text-primary text-decoration-none">Forgot?</a>
                    </div>
                    <div class="input-group">
                        <span class="input-group-text bg-white border-end-0 rounded-start-4">
                ...
                <div class="mb-4 form-check">
                    ...
                    <label class="form-check-label small text-slate-400" for="remember">Stay signed in for 30 days</label>
                </div>
                ...
                <div class="text-center">
                    <p class="text-slate-400 small mb-0">Don't have an account? 
